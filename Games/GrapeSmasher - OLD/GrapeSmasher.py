...
def game_loop():
    ...
    bg = pygame.image.load("Games/GrapeSmasher/landscape.jpg")  #CHANGE BACK TO Games/landscape.jpg
    sprite_sheet = pygame.image.load("Games/GrapeSmasher/Walk.png") 
    frame_width = 36  
    frame_height = 48  
    scale_factor = 15
    ...
    #load the barrel
    barrel = pygame.image.load("Games/GrapeSmasher/Barrel-of-grapes.png")  
